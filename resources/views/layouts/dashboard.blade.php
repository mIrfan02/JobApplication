...
<div class="row">
    <div class="col-md-12 stretch-card">
      <div class="card">
        <div class="card-body">
          <p class="card-title">Recent Applicants</p>
              ...
              <tbody>
                ...
                <tr>
                  <td>{{ $job->id }}</td>
                    ...
                    <td >
                      <button class="email-button " onclick="modalopen('{{ $job->email }}')" id="myBtn" data-email="{{ $job->email }}"><i class="fa fa-envelope-o" aria-hidden="true"></i></button>
                      ...
                      <button id="openModalBtn" onclick="Message('{{ $job->user_id }}')"  data-person-id="{{ $job->id }}">Send Message</button>

                      
                      <form action="{{ route('approve', $job->id) }}" method="POST">
                        @csrf
                     <button type="submit" id="cmp" class="update-btn"><i class="fa fa-thumbs-up" aria-hidden="true"></i></button>
